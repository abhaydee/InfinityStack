...
const feeds = [
  {
    ...
    price: 100_000_000,
    type: "Crypto",
    impliedVolatility: Math.round(0.3 * satoshiPerBTC),
    pythFeedId:
  ...
  },
  {
    ...
    price: 0,
    type: "Crypto",
    impliedVolatility: Math.round(14.3 * satoshiPerBTC),
    pythFeedId:
  ...
  },
  {
    ...
    price: 0,
    type: "Crypto",
    impliedVolatility: Math.round(13.2 * satoshiPerBTC),
    pythFeedId:
  ...
  },
  {
    ...
    price: 0,
    type: "Crypto",
    impliedVolatility: Math.round(6.23 * satoshiPerBTC),
    pythFeedId:
  ...
  },
  {
    ...
    price: 0,
    type: "Crypto",
    impliedVolatility: Math.round(2.5 * satoshiPerBTC),
    pythFeedId:
  ...
  },
  {
    ...
    price: 0,
    type: "Crypto",
    impliedVolatility: Math.round(11.5 * satoshiPerBTC),
    pythFeedId:
  ...
  },
  {
    ...
    price: 0,
    type: "Crypto",
    impliedVolatility: Math.round(7.55 * satoshiPerBTC),
    pythFeedId:
  ...
  },
  {
    ...
    price: 0,
    type: "Crypto",
    impliedVolatility: Math.round(3.44 * satoshiPerBTC),
    pythFeedId:
  ...
  },
  {
    ...
    price: 0,
    type: "Crypto",
    impliedVolatility: Math.round(15.3 * satoshiPerBTC),
    pythFeedId:
  ...
  },
  {
    ...
    price: 0,
    type: "Crypto",
    impliedVolatility: Math.round(8.1 * satoshiPerBTC),
    pythFeedId:
...
const addFeeds = async () => {
  const nonceInfo = await fetch(
    `${network.coreApiUrl}/extended/v1/address/${address}/nonces`
  );
...
const addSupportedFeeds = async () => {
  ...
  console.log(
    `Setting supported feeds for Bitthetix on-chain (nonce: ${nonce}).`
  );
...
const updateSupportedFeeds = async () => {
  ...
  console.log(
    `Updating feed data for InfinityStack on-chain (nonce: ${nonce}).`
  );
  ...
  const supportedFeeds = Array.from({ length: feeds.length }, (_, i) => {
    return tupleCV({
      "feed-id": uintCV(i),
      "current-value": uintCV(feeds[i].price),
    });
  });
  const postConditions = [];
  const addFeedOptions = {
